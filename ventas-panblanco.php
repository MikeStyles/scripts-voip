...
$agi->answer();
sleep(1);
$agi->exec_agi("googletts.agi,\"Usted compro un pan blanco\",es");

require("definiciones.inc");
$link = mysql_connect(MAQUINA, USUARIO,CLAVE); 
mysql_select_db(DB, $link); 
$result = mysql_query("INSERT INTO ventas (nombre, costo, envoltura) VALUES ('Pan blanco', 1000, 'Bolsa plastica');", $link);
